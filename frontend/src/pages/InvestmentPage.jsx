      ...
      <div style={{ display:'flex', flexDirection:'column', gap:'1.25rem', padding:'0 1.25rem' }}>
        ...
        <div style={{
          ...
          <div style={{ position:'relative', zIndex:1 }}>
            ...
            <div style={{ display:'inline-block', background: 'rgba(144,247,194,0.15)', padding: '0.5rem 1rem', borderRadius: 'var(--r-full)', marginBottom: '1.5rem' }}>
                  ...
                  <div style={{ display:'flex', alignItems:'center', gap:'0.875rem', padding:'0.25rem 0' }}>
                    ...
                    {editing ? (
                      <div style={{ display:'flex', alignItems:'center', gap:'0.375rem' }}>
                        <button className="btn-icon ic-surface" style={{ width:'2rem', height:'2rem' }} onClick={() => upd(b.key, share - 5)}>
